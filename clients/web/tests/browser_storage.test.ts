...
// gitignored and generated by `npm run prepare-wasm`).  BrowserStorage itself
// never calls into WASM, but the barrel export in src/index.ts re-exports App,
// which imports the WASM module at module-evaluation time.
vi.mock('../../../core/bindings/wasm/pkg/index.js', () => ({
  generate_identity: () => ({ public_bytes: () => new Uint8Array(32) }),
